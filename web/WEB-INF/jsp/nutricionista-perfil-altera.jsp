<%-- 
    Document   : nutricionista-perfil-altera
    Created on : 20/06/2015, 18:12:58
    Author     : Luciana
--%>
                                ...
                                <div class="profile-body">
                                    <div class="col-lg-12">
                                        <div id="settings" class="tab-pane">
                                            ...
                                            '   <form action="mvc?logica=AlteraNutricionistaPerfil" method="POST">
                                                <input type="hidden" name="idNutricionista" value="${nutricionista.idNutricionista}">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                    ...
                                                    <hr class="wide">
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <span class="input-icon icon-right">
                                                                        <input type="password" name="senha" class="form-control" value="${nutricionista.senha}">
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <a href="mvc?logica=LstNutricionistaPerfil&id=${nutricionista.idNutricionista}" class="btn btn-primary">Cancelar</a>
                                                                </div>
                                                            </div>   
                                                        </div>
                                                </form>
