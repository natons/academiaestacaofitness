                                                ...
                                                <hr class="wide">
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input type="password" class="form-control" value="${recepcionista.senha}" readonly>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <form action="mvc?logica=FotoUploadRecepcionista&idRecepcionista=${usuario.idRecepcionista}" method="POST" enctype="multipart/form-data" >
                                                                        <i class="glyphicon glyphicon-camera"></i>
                                                                        <input type="file" id="file" name="file" size="150" value=""/>
                                                    ...
                                                    <a href="mvc?logica=MostraRecepcionistaPerfil&id=${usuario.idRecepcionista}" class="btn btn-primary">Editar</a>
