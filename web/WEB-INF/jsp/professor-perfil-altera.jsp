<%-- 
    Document   : professor-perfil-altera
    Created on : 19/06/2015, 10:42:42
    Author     : Luciana
--%>
...
<head>
    ...
    <meta name="description" content="Professor-Perfil" />
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li>
                                <a class=" dropdown-toggle" data-toggle="dropdown" title="Dúvidas" href="#">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        ...
                                        <div class="databox-right padding-top-20">
                                            ...
                                            <div class="databox-text darkgray">Professor</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="perfil" class="profile-container">
                                <div class="profile-header row">
                                    <div class="col-lg-2 col-md-4 col-sm-12 text-center">
                                        <img src="${professor.urlFoto}" alt="" class="header-avatar" />
                                    </div>
                                    <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
                                        <div class="header-fullname"><h1>${professor.nome}</h1></div>
                                    </div>
                                    <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 profile-stats">
                                        <div class="row">
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 stats-col">
                                                <div class="stats-value darkcarbon">${professor.cpf}</div>
                                                <div class="stats-title">CPF</div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 stats-col">
                                                <div class="stats-value darkcarbon">${professor.status}</div>
                                                <div class="stats-title">Status</div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-4 inlinestats-col">
                                                <i class="glyphicon glyphicon-map-marker"></i> ${professor.endereco}
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 inlinestats-col">
                                                Tipo: <strong>Professor</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="profile-body">
                                    <div class="col-lg-12">
                                        <div id="settings" class="tab-pane">
                                            ...
                                            '   <form action="mvc?logica=AlteraProfessorPerfil" method="POST">
                                                <input type="hidden" name="idProfessor" value="${professor.idProfessor}">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input type="text" class="form-control" value="${professor.nome}" disabled/>
                                                        ...
                                                        <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <span class="input-icon icon-right">
                                                                        <input class="form-control" value="${professor.cpf}" type="text" disabled/>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input type="text" class="form-control" value="${professor.matricula}" disabled="">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input type="text" class="form-control" value="${professor.endereco}" disabled="">
                                                    ...
                                                    <hr class="wide">
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <span class="input-icon icon-right">
                                                                        <input type="password" name="senha" class="form-control" value="${professor.senha}">
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <a href="mvc?logica=LstProfessorPerfil&id=${professor.idProfessor}" class="btn btn-primary">Cancelar</a>
                                                                </div>
                                                            </div>   
                                                        </div>
                                                </form>
