...
<head>
    ...
    <meta name="description" content="Recepcionista-Nutricionistas" />
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <a href="mvc?logica=MostraNutricionista" class="btn btn-default">
                                            Novo Nutricionista
                                        </a>
                                    </div>
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-hover table-bordered font-90" id="editabledatatable">
                                            ...
                                            <tbody>
                                                <form action="mvc?logica=AlteraNutricionistaLogica" method="POST">
                                                    <tr>
                                                        <!-- HIDDENS VALORES -->
                                                        <input type="hidden" value="${nutricionista.idNutricionista}" name="idNutricionista"/>

                                                        <td>
                                                            <input name="nome" class="input-small small" type="text" value="${nutricionista.nome}"/>
                                                        </td>
                                                        <td>
                                                            <input name="matricula" class="input-small small" type="text" value="${nutricionista.matricula}"/>
                                                        </td>
                                                        <td>
                                                            <input name="cpf" class="input-small small" type="text" value="${nutricionista.cpf}"/>
                                                        </td>
                                                        <td>
                                                            <input name="endereco" class="input-small small" type="text" value="${nutricionista.endereco}"/>
                                                        </td>
                                                        <td> 
                                                            <c:choose>
                                                                <c:when test="${nutricionista == null}">
                                                                    <input name="telefone1" type="text" class="input-small small" value="" />
                                                                    <input name="telefone2" type="text" class="input-small small" value="" />
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <c:forEach var="telefone" items="${nutricionista.telefones}" varStatus="nome">
                                                        ...
                                                        <td>
                                                            <input name="senha" class="input-small small" type="password" value="${nutricionista.senha}" />
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="mvc?logica=ListaNutricionistaLogica" class="btn btn-warning btn-xs cancel">
                                                                <i class="fa fa-times"></i> 
                                                                Cancelar
                                                            </a>
                                                        </td>
