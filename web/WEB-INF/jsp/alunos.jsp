...
<head>
    ...
    <title>Painel Administrativo Alunos </title>

    <meta name="description" content="Recepcionista-Alunos" />
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tabela de Alunos</span>
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <a id="editabledatatable_new" href="mvc?logica=MostraAluno" class="btn btn-default">
                                            Novo Aluno
                                        </a>
                                    </div>
                                            ...
                                            <tbody>
                                                <c:forEach var="aluno" items="${alunos}">
                                                    <tr class="small">
                                                        ...
                                                        <td>
                                                            <input name="nome" class="input-small input-transparente" type="hidden" value="${aluno.nome}" disabled=""/>
                                                            ${aluno.nome}
                                                        </td>
                                                        <td>
                                                            <input name="matricula" class="input-small input-transparente" type="hidden" value="${aluno.matricula}" disabled=""/>
                                                            ${aluno.matricula}
                                                        </td>
                                                        <td>
                                                            <input name="endereco" class="input-small input-transparente" type="hidden" value="${aluno.endereco}" disabled=""/>
                                                            ${aluno.endereco}
                                                        </td>
                                                        <td> 
                                                        ...
                                                        <td>
                                                            <input name="status" type="hidden" class="input-small input-transparente" value="${aluno.status}" disabled/>
                                                            ${aluno.status}
                                                        </td>
                                                        <td>
                                                            <input class="input-small input-transparente" type="hidden" value="${aluno.senha}" disabled/>
                                                            ${aluno.senha}
                                                        </td>
                                                        <td>
                                                            <input name="dataNascimento" class="input-small input-transparente" type="hidden" value="${aluno.dataNascimento}" disabled/>
                                                            <fmt:formatDate value="${aluno.dataNascimento}" type="DATE" pattern="dd/MM/yyyy"/>
                                                        </td>
                                                        <td>
                                                            <a href="mvc?logica=MostraAluno&id=${aluno.idAluno}" class="btn btn-info btn-xs edit">
                                                                <i class="fa fa-edit"></i> 
                                                                Editar
                                                            </a>
                                                            <a href="mvc?logica=RemoveAlunoLogica&id=${aluno.idAluno}" class="btn btn-danger btn-xs delete">
