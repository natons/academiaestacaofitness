 ...
 *
 * Traduzido por: César Henrique :: http://fb.com/cezarhenrikue 
 */
(function (factory) {
  /* global define */
    ...
    lang: {
      'pt-BR': {
        ...
        image: {
          ...
          resizeQuarter: 'Redimensionar 1/4',
          floatLeft: 'Alinhar à Esquerda',
          floatRight: 'Alinhar à Direita',
          floatNone: 'Nenhum Alinhamento',
          dragImageHere: 'Arraste uma imagem aqui',
          selectFromFiles: 'Selecione a partir de arquivos',
          url: 'URL da Imagem',
        ...
        link: {
          ...
          url: 'Para onde a URL do link deve ir?',
          openInNewWindow: 'Abrir em nova guia'
        },
        video: {
          video: 'Vídeo',
        ...
        color: {
          ...
          foreground: 'Cor de Realce',
          transparent: 'Transparente',
          setTransparent: 'Selecionar transparente',
          reset: 'Resetar',
    ...
    var attachDragAndDropEvent = function (layoutInfo) {
      ...
      $document.on('dragenter', function (e) {
        ...
        if (!isCodeview && !collection.length) {
          ...
          $dropzoneMessage.text('Arraste imagem para cá');
        }
      ...
      $dropzone.on('dragenter', function () {
        ...
        $dropzoneMessage.text('Solte a imagem aqui');
