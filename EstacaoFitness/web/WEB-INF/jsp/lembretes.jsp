...
<head>
    <meta charset="utf-8" />
    <title>Painel Administrativo Lembretes </title>
...
<body>
                                        ...
                                        <tbody>
                                                <c:forEach var="lembrete" items="${lembretes}">
                                                    <tr class="small">
                                                        ...
                                                        <td>
                                                            <input name="titulo" class="input-small input-transparente" type="hidden" value="${lembrete.titulo}" disabled=""/>
                                                            ${lembrete.titulo}
                                                        </td>
                                                        <td>
                                                            <textarea name="corpo" class="form-control"  rows="2" disabled="">${lembrete.corpo}</textarea>
                                                        </td>
                                                        <td>
                                                            <a href="mvc?logica=MostraLembrete&id=${lembrete.idLembrete}" class="btn btn-info btn-xs edit">
                                                                <i class="fa fa-edit"></i> 
                                                                Editar
                                                            </a>
                                                            <a href="mvc?logica=RemoveLembreteLogica&id=${lembrete.idLembrete}" class="btn btn-danger btn-xs delete">
    ...
    <script>
        InitiateSimpleDataTablePequena.init();
    </script>
