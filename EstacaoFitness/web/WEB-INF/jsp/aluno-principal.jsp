...
<head>
    ...
    <title>Painel Administrativo Aluno</title>
                ...
                <div class="page-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-lightyellow bg-preto">
                                    <span class="widget-caption"><h5>Dieta</h5></span>
                                    ...
                                    <div class="widget-main ">
                                        <div class="panel-group accordion" id="accordion">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body border-red">
                                                    <div class="col-lg-12">
                                                        <h4 class="row-title before-black">${usuario.dieta.descricao}</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            <div class="widget flat radius-bordered">
                                <div class="widget-header bordered-bottom bordered-lightyellow bg-preto">
                                    <span class="widget-caption">Sugestão</span>
                                </div>
                                <div class="widget-body">
                                    <div id="registration-form">
                                        <form action="mvc?logica=AlteraAlunoSugestao" method="POST">
                                            <input type="hidden" name="idSugestao" value="" />
                                            <input type="hidden" name="idAlunoFK" value="${usuario.idAluno}"/>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-icon icon-right">
                                                            <select class="form-control" name="areaSugestao">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <p class="help-block">Digite sua sugestão no campo acima.</p>
                                                    </div>
                        ...
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            <div class="widget">
                                <div class="widget-header bordered-bottom bordered-yellow bg-preto">
                                    <span class="widget-caption">Exercícios</span>
                                    <div class="widget-buttons">
                                        <a href="#" data-toggle="maximize">
                                            <i class="fa fa-expand"></i>
                                        </a>
                                ...
                                <div class="widget-body bg-white bordered-bottom bordered-darkcarbon carbon">
                                    <c:forEach var="exercicio" items="${usuario.exercicios}">
                                        <div class="row">
                                            <c:forEach var="tipo" items="${exercicio.tipos}">
                                                <div class="col-lg-6">
                                                    <h4 class="bold">${tipo.nome}</h4>
                                                    <hr class="wide"></hr>
                                                </div>
                                            </c:forEach>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h6 class="row-title before-black">
                                                    ${exercicio.descricao}
                                                </h6>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <a href="mvc?logica=LstAlunoExercicio" class="btn btn-yellow btn-block shiny">Ver todos</a>
                                        </div>
                                    </div>
                                </div><!--Widget Body-->
                            </div><!--Widget-->
