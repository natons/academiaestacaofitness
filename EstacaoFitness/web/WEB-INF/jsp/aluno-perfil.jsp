                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        <div class="databox-left no-padding">
                                            <img src="${aluno.urlFoto}" style="width:65px; height:65px;">
                                        </div>
                                        ...
                                        <div id="settings" class="tab-pane">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input class="form-control date-picker" id="id-date-picker-1" value="<fmt:formatDate value="${aluno.dataNascimento}" type="DATE" pattern="dd/MM/yyyy"/>" type="text" data-date-format="dd-mm-yyyy" disabled/>
                                                                        <i class="fa fa-calendar"></i>
                                                                </span>
                                                            </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <span class="input-icon icon-right">
                                                                <input type="text" class="form-control" value="${aluno.endereco}" disabled="">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <span class="input-icon icon-right">
                                                                <input type="text" class="form-control" value="${aluno.peso}" disabled/>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr class="wide">
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input type="password" class="form-control" value="${aluno.senha}" readonly>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <form action="mvc?logica=FotoUploadAluno&idAluno=${aluno.idAluno}" method="POST" enctype="multipart/form-data" >
                                                    ...
                                                    <a href="mvc?logica=MostraAlunoPerfil&id=${usuario.idAluno}" class="btn btn-primary">Editar</a>
