                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <a href="mvc?logica=MostraAluno" class="btn btn-default">
                                            Novo Aluno
                                        </a>
                                    </div>
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-hover table-bordered font-90" id="editabledatatable">
                                            ...
                                            <tbody>
                                                <form action="mvc?logica=AlteraAlunoLogica" method="POST">
                                                    <tr>
                                                        <!-- HIDDENS VALORES -->
                                                        <input type="hidden" value="${aluno.idAluno}" name="idAluno"/>

                                                        <td>
                                                            <input name="nome" class="input-small small" type="text" value="${aluno.nome}"/>
                                                        </td>
                                                        <td>
                                                            <input name="matricula" class="input-small small" type="text" value="${aluno.matricula}"/>
                                                        </td>
                                                        <td>
                                                            <input name="endereco" class="input-small small" type="text" value="${aluno.endereco}"/>
                                                        </td>
                                                        <td> 
                                                            <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                    <c:forEach var="telefone" items="${aluno.telefones}" varStatus="nome">
                                                        ...
                                                        <td>
                                                            <input class="input-small small" type="text" value="${aluno.peso}" name="peso"/>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input name="senha" class="input-small small" type="password" value="${aluno.senha}" />
                                                        </td>
                                                        <td>
                                                            <input name="dataNascimento" class="input-small small" type="date" value="${aluno.dataNascimento}" />
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="mvc?logica=ListaAlunoLogica" class="btn btn-warning btn-xs cancel">
                                                                <i class="fa fa-times"></i> 
                                                                Cancelar
                                                            </a>
                                                        </td>
