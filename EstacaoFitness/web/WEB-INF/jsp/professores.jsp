                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <a id="editabledatatable_new" href="mvc?logica=MostraProfessor" class="btn btn-default">
                                            Novo Professor
                                        </a>
                                    </div>
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                                            ...
                                            <tbody>
                                                <c:forEach var="professores" items="${professores}">
                                                    <tr class="small">
                                                        <input type="hidden" value="${professores.idProfessor}" name="idEstagiario"/>
                                                        <td>
                                                            <input name="nome" class="input-small input-transparente" type="hidden" value="${professores.nome}" disabled=""/>
                                                            ${professores.nome}
                                                        </td>
                                                        <td>
                                                            <input name="matricula" class="input-small input-transparente" type="hidden" value="${professores.matricula}" disabled=""/>
                                                            ${professores.matricula}
                                                        </td>
                                                        <td>
                                                            <input name="cpf" class="input-small input-transparente" type="hidden" value="${professores.cpf}" disabled=""/>
                                                            ${professores.cpf}
                                                        </td>
                                                        <td>
                                                            <input name="endereco" class="input-small input-transparente" type="hidden" value="${professores.endereco}" disabled=""/>
                                                            ${professores.endereco}
                                                        </td>
                                                        <td> 
                                                            <c:forEach var="telefone" items="${professores.telefones}">
                                                                <input name="numero" type="hidden" class="input-small input-transparente" value="${telefone.numero}" disabled/>
                                                                ${telefone.numero}
                                                            </c:forEach>
                                                        </td>
                                                        <td>
                                                            <input name="status" type="hidden" class="input-small input-transparente" value="${professores.status}" disabled/>
                                                            ${professores.status}
                                                        </td>
                                                        <td>
                                                            <input class="input-small input-transparente" type="hidden" value="${professores.senha}" disabled/>
                                                            ${professores.senha}
                                                        </td>
                                                        <td>
                                                            <a href="mvc?logica=MostraProfessor&id=${professores.idProfessor}" class="btn btn-info btn-xs edit">
                                                                <i class="fa fa-edit"></i> 
                                                                Editar
                                                            </a>
                                                            <a href="mvc?logica=RemoveProfessorLogica&id=${professores.idProfessor}" class="btn btn-danger btn-xs delete">
