<%-- 
    Document   : estagiario-perfil-altera
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox bg-white radius-bordered">
                                        ...
                                        <div class="databox-right padding-top-20">
                                            ...
                                            <div class="databox-text darkgray">Estagiario</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="profile-body">
                                    <div class="col-lg-12">
                                        <div id="settings" class="tab-pane">
                                            ...
                                            '   <form action="mvc?logica=AlteraEstagiarioPerfil" method="POST">
                                                <input type="hidden" name="idEstagiario" value="${estagiario.idEstagiario}">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                    ...
                                                    <hr class="wide">
                                                        <div class="row">
                                                            <div class="col-sm-5">
                                                                <div class="form-group">
                                                                    <span class="input-icon icon-right">
                                                                        <input type="password" name="senha" class="form-control" value="${estagiario.senha}">
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <a href="mvc?logica=LstEstagiarioPerfil&id=${estagiario.idEstagiario}" class="btn btn-primary">Cancelar</a>
                                                                </div>
                                                            </div>   
                                                        </div>
                                                </form>
