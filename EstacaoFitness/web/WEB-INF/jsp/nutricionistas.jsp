...
<head>
    ...
    <title>Painel Administrativo Nutricionistas </title>

    <meta name="description" content="Recepcionista-Nutricionista" />
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tabela de Nutricionistas</span>
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <a id="editabledatatable_new" href="mvc?logica=MostraNutricionista" class="btn btn-default">
                                            Novo Nutricionista
                                        </a>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed flip-content font-90" id="editabledatatable">
                                            ...
                                            <tbody>
                                                <c:forEach var="nutricionista" items="${nutricionistas}">
                                                    <tr class="small">
                                                        <input type="hidden" value="${nutricionista.idNutricionista}" name="idEstagiario"/>
                                                        <td>
                                                            <input name="nome" class="input-small input-transparente" type="hidden" value="${nutricionista.nome}" disabled=""/>
                                                            ${nutricionista.nome}
                                                        </td>
                                                        <td>
                                                            <input name="matricula" class="input-small input-transparente" type="hidden" value="${nutricionista.matricula}" disabled=""/>
                                                            ${nutricionista.matricula}
                                                        </td>
                                                        <td>
                                                            <input name="cpf" class="input-small input-transparente" type="hidden" value="${nutricionista.cpf}" disabled=""/>
                                                            ${nutricionista.cpf}
                                                        </td>
                                                        <td>
                                                            <input name="endereco" class="input-small input-transparente" type="hidden" value="${nutricionista.endereco}" disabled=""/>
                                                        ...
                                                        <td>
                                                            <input name="status" type="hidden" class="input-small input-transparente" value="${nutricionista.status}" disabled/>
                                                            ${nutricionista.status}
                                                        </td>
                                                        <td>
                                                            <input class="input-small input-transparente" type="hidden" value="${nutricionista.senha}" disabled/>
                                                            ${nutricionista.senha}
                                                        </td>
                                                        <td>
                                                            <a href="mvc?logica=MostraNutricionista&id=${nutricionista.idNutricionista}" class="btn btn-info btn-xs edit">
                                                                <i class="fa fa-edit"></i> 
                                                                Editar
                                                            </a>
                                                            <a href="mvc?logica=RemoveNutricionistaLogica&id=${nutricionista.idNutricionista}" class="btn btn-danger btn-xs delete">
