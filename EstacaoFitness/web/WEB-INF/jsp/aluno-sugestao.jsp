                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Minhas sugestões</span>
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#addSugestao">
                                            Nova Sugestão
                                        </button>
                                    </div>
                                    ...
                                    <!-- Tela de inserção de sugestao -->    
                                    <div class="modal fade" id="addSugestao" tabindex="-1" role="dialog" aria-hidden="true">
                                        ...
                                        <tbody>
                                            <c:forEach var="sugestao" items="${sugestoes}">
                                                <tr>
                                                    ...
                                                    <td>${sugestao.areaSugestao}</td>
                                                    <td><fmt:formatDate value="${sugestao.data}" type="DATE" pattern="dd/MM/yyyy"/></td>
                                                    <td>Feita</td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
