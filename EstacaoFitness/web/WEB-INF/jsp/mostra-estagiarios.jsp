...
<head>
    ...
    <title>Painel Administrativo Estagiários</title>
                        ...
                        <div class="col-xs-12 col-md-12">
                            <div class="widget">
                                <div class="widget-header ">
                                    <span class="widget-caption">Tabela de Estagiários</span>
                                ...
                                <div class="widget-body">
                                    <div class="table-toolbar">
                                        <a href="mvc?logica=MostraEstagiario" class="btn btn-default">
                                            Novo Estagário
                                        </a>
                                    </div>
                                    <div class="table-scrollable">
                                        <table class="table table-striped table-hover table-bordered font-90" id="editabledatatable">
                                            ...
                                            <tbody>
                                                <form action="mvc?logica=AlteraEstagiarioLogica" method="POST">
                                                    <tr>
                                                        <!-- HIDDENS VALORES -->
                                                        <input type="hidden" value="${estagiario.idEstagiario}" name="idEstagiario"/>

                                                        <td>
                                                            <input name="nome" class="input-small small" type="text" value="${estagiario.nome}"/>
                                                        </td>
                                                        <td>
                                                            <input name="matricula" class="input-small small" type="text" value="${estagiario.matricula}"/>
                                                        </td>
                                                        <td>
                                                            <input name="cpf" class="input-small small" type="text" value="${estagiario.cpf}"/>
                                                        </td>
                                                        <td>
                                                            <input name="endereco" class="input-small small" type="text" value="${estagiario.endereco}"/>
                                                        </td>
                                                        <td> 
                                                            <c:choose>
                                                                <c:when test="${estagiario == null}">
                                                                    <input name="telefone1" type="text" class="input-small small" value="" />
                                                                    <input name="telefone2" type="text" class="input-small small" value="" />
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <c:forEach var="telefone" items="${estagiario.telefones}" varStatus="nome">
                                                        ...
                                                        <td>
                                                            <input name="senha" class="input-small small" type="password" value="${estagiario.senha}" />
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="mvc?logica=ListaEstagiarioLogica" class="btn btn-warning btn-xs cancel">
                                                                <i class="fa fa-times"></i> 
                                                                Cancelar
                                                            </a>
                                                        </td>
