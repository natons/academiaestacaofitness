                                                ...
                                                <hr class="wide">
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <input type="password" class="form-control" value="${professor.senha}" readonly>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-5">
                                                            <div class="form-group">
                                                                <span class="input-icon icon-right">
                                                                    <form action="mvc?logica=FotoUploadProfessor&idProfessor=${professor.idProfessor}" method="POST" enctype="multipart/form-data" >
                                                    ...
                                                    <a href="mvc?logica=MostraProfessorPerfil&id=${usuario.idProfessor}" class="btn btn-primary">Editar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
